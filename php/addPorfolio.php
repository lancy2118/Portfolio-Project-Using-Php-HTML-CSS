...
<html lang="en">
   ...
   if(!empty($_POST['projectName']) && !empty($_POST['projectDesc'])) { 
    ...
    $sql="INSERT INTO portfoliodesc (projectName, projectDesc,projectPic,userName)
VALUES ('".$projectNameUpdate."', '".$projectDescUpdate."','".$img."','lancy2118')"; 
  
    if ($conn->query($sql) === TRUE) { 
    echo '<script type="text/javascript">'; 
  echo 'alert("Inserted portfolio successfully");'; 
  ...
  echo '</script>';   
    ...
    $err="All fields are required!";  
        ...
        <form action="" method='POST'>
          ...
          <input type="text" id="projectName" name="projectName" class='signText' required> 
          <label for="projectDesc">Description</label>
          <input type="text" id="projectDesc" name="projectDesc" class='signText' required>
          <label for="imageUpload">Upload Project Image</label>
          <input type="file" name="imageUpload" id="imageUpload" class='signText'>
          <p><?php echo $err;?></p>
