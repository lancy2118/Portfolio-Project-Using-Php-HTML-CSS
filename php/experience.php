...
<html lang="en">
    ...
    <body>
        ...
        <?php
            ...
            $sql = "SELECT joiningDate,endDate,companyName,role,description FROM workexp order by companyName desc";
        ...
        <section class="wrapper education">
          ...
          <div class="boxs a">
            <h3><?php echo $row["joiningDate"]. "-" .$row["endDate"]; ?></h3>
            <h3><?php echo $row["companyName"]; ?></h3>
            </div>
          <div class="boxs b">
              <h3 class='title-head'><?php echo $row["role"]; ?></h3>
